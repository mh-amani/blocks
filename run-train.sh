...
# ----------------------------------------------- SCAN ---------------------------------------------- #
# supervised:
python3 run_train.py +experiment=scan_suponly.yaml model/discretizer=gumbel datamodule.dataset_parameters.supervision_ratio="[0.01, 0.9]" trainer.devices=[1] datamodule.dataset_parameters.train_ratio=0.99 || true
python3 run_train.py +experiment=scan_suponly.yaml model/discretizer=gumbel datamodule.dataset_parameters.supervision_ratio="[0.02, 0.9]" trainer.devices=[1] datamodule.dataset_parameters.train_ratio=0.99 || true
python3 run_train.py +experiment=scan_suponly.yaml model/discretizer=gumbel datamodule.dataset_parameters.supervision_ratio="[0.04, 0.9]" trainer.devices=[1] datamodule.dataset_parameters.train_ratio=0.99 || true
python3 run_train.py +experiment=scan_suponly.yaml model/discretizer=gumbel datamodule.dataset_parameters.supervision_ratio="[0.08, 0.9]" trainer.devices=[1] datamodule.dataset_parameters.train_ratio=0.99 || true
python3 run_train.py +experiment=scan_suponly.yaml model/discretizer=gumbel datamodule.dataset_parameters.supervision_ratio="[0.16, 0.9]" trainer.devices=[1] datamodule.dataset_parameters.train_ratio=0.99 || true
python3 run_train.py +experiment=scan_suponly.yaml model/discretizer=gumbel datamodule.dataset_parameters.supervision_ratio="[0.32, 0.9]" trainer.devices=[1] datamodule.dataset_parameters.train_ratio=0.99 || true
python3 run_train.py +experiment=scan_suponly.yaml model/discretizer=gumbel datamodule.dataset_parameters.supervision_ratio="[0.64, 0.9]" trainer.devices=[1] datamodule.dataset_parameters.train_ratio=0.99 || true
python3 run_train.py +experiment=scan_suponly.yaml model/discretizer=gumbel datamodule.dataset_parameters.supervision_ratio="[1.0, 0.9]" trainer.devices=[1] datamodule.dataset_parameters.train_ratio=0.99 || true


# weakly supervised:
# python3 run_train.py +experiment=scan_pretrained_weaksup.yaml datamodule.dataset_parameters.supervision_ratio="[0.01, 0.9]" trainer.devices=[1] datamodule.dataset_parameters.batch_size=256  model.checkpoint_path="/home/masani/blocks/logs/training/runs/supervised-only-0.01-gumbel/2023-09-24_21-21-14/checkpoints/last.ckpt" callbacks.supervision_scheduler.scheduler_xz.hp_init=1.0 callbacks.supervision_scheduler.scheduler_xz.hp_end=0.7 callbacks.supervision_scheduler.scheduler_z.hp_init=1.0 callbacks.supervision_scheduler.scheduler_z.hp_end=0.7 logger.wandb.tags=["weakly-supervised"] || true
