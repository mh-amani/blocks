...
# python3 run_train.py +experiment=scan_gpt2-gpt2_gumbel_supervised.yaml datamodule.dataset_parameters.supervision_ratio="[0.02, 0.9]" trainer.devices=[1] +test=True || true
# python3 run_train.py +experiment=scan_gpt2-gpt2_gumbel_supervised.yaml datamodule.dataset_parameters.supervision_ratio="[0.04, 0.9]" trainer.devices=[1] +test=True || true
# python3 run_train.py +experiment=scan_gpt2-gpt2_gumbel_supervised.yaml datamodule.dataset_parameters.supervision_ratio="[0.06, 0.9]" trainer.devices=[1] +test=True || true
# python3 run_train.py +experiment=scan_gpt2-gpt2_gumbel_supervised.yaml datamodule.dataset_parameters.supervision_ratio="[0.08, 0.9]" trainer.devices=[1] +test=True || true
# python3 run_train.py +experiment=scan_gpt2-gpt2_gumbel_supervised.yaml datamodule.dataset_parameters.supervision_ratio="[0.1, 0.9]" trainer.devices=[1] +test=True || true
# python3 run_train.py +experiment=scan_gpt2-gpt2_gumbel_supervised.yaml datamodule.dataset_parameters.supervision_ratio="[0.2, 0.9]" trainer.devices=[1] +test=True || true
# python3 run_train.py +experiment=scan_gpt2-gpt2_gumbel_supervised.yaml datamodule.dataset_parameters.supervision_ratio="[0.2, 0.9]" trainer.devices=[1] +test=True || true
# python3 run_train.py +experiment=scan_gpt2-gpt2_gumbel_supervised.yaml datamodule.dataset_parameters.supervision_ratio="[0.3, 0.9]" trainer.devices=[1] +test=True || true
